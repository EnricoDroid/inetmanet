...
#ifndef IEEE_80211MIMLD_MAC_H
#define IEEE_80211MIMLD_MAC_H
...
#include "Ieee80211MimldConsts.h"
 ...
 * @ingroup macLayer
 */
class INET_API Ieee80211MimldMac : public WirelessMacBase, public INotifiable
{
