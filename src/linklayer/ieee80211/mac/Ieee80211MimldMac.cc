...
#include <algorithm>
#include "Ieee80211MimldMac.h"
#include "RadioState.h"
#include "IInterfaceTable.h"
#include "InterfaceTableAccess.h"
#include "PhyControlInfo_m.h"

Define_Module(Ieee80211MimldMac);

// don't forget to keep synchronized the C++ enum and the runtime enum definition
Register_Enum(Ieee80211MimldMac,
              (Ieee80211MimldMac::IDLE,
               Ieee80211MimldMac::DEFER,
               Ieee80211MimldMac::WAITDIFS,
               Ieee80211MimldMac::BACKOFF,
               Ieee80211MimldMac::WAITACK,
               Ieee80211MimldMac::WAITBROADCAST,
               Ieee80211MimldMac::WAITCTS,
               Ieee80211MimldMac::WAITSIFS,
               Ieee80211MimldMac::RECEIVE));
 ...
 */
Ieee80211MimldMac::Ieee80211MimldMac()
{
    endSIFS = NULL;
    endDIFS = NULL;
    endBackoff = NULL;
 ...
 */
void Ieee80211MimldMac::initialize(int stage)
{
    ...
    if (stage == 0)
    {
        ...
        // state variables
        fsm.setName("Ieee80211MimldMac State Machine");
        mode = DCF;
        sequenceNumber = 0;
        ...
        stateVector.setEnum("Ieee80211MimldMac");
...
void Ieee80211MimldMac::registerInterface()
{
...
void Ieee80211MimldMac::initializeQueueModule()
{
 ...
 */
void Ieee80211MimldMac::handleSelfMsg(cMessage *msg)
{
...
void Ieee80211MimldMac::handleUpperMsg(cPacket *msg)
{
...
void Ieee80211MimldMac::handleCommand(cMessage *msg)
{
...
void Ieee80211MimldMac::handleLowerMsg(cPacket *msg)
{
...
void Ieee80211MimldMac::receiveChangeNotification(int category, const cPolymorphic *details)
{
    Enter_Method_Silent();
 ...
 */
void Ieee80211MimldMac::handleWithFSM(cMessage *msg)
{
...
void Ieee80211MimldMac::finishReception()
{
    if (!transmissionQueue.empty())
    {
        backoff = true;
...
simtime_t Ieee80211MimldMac::computeBackoffPeriod(Ieee80211Frame *msg, int r)
{
    int cw;
    ...
    else
    {
        ...
        if (lastFailed){
        	cwNew=cwNew*2;
        	cwNew=((cwNew)>(cwBasic)?(cwNew):(cwBasic));
        }
        else if (!lastFailed && cwNew>cwBasic) {
        	cwNew=cwNew/2;
        	cwNew=((cwNew)>(cwBasic)?(cwNew):(cwBasic));
		}
        else if (!lastFailed && cwNew<=cwBasic) {
			cwNew=--cwNew;
			cwNew=((cwNew)>(cwMinData)?(cwNew):(cwMinData));
		}
 ...
 * Timer functions.
 */
void Ieee80211MimldMac::scheduleSIFSPeriod(Ieee80211Frame *frame)
{
...
void Ieee80211MimldMac::scheduleDIFSPeriod()
{
...
void Ieee80211MimldMac::cancelDIFSPeriod()
{
    EV << "cancelling DIFS period\n";
    cancelEvent(endDIFS);
}

void Ieee80211MimldMac::scheduleDataTimeoutPeriod(Ieee80211DataOrMgmtFrame *frameToSend)
{
...
void Ieee80211MimldMac::scheduleBroadcastTimeoutPeriod(Ieee80211DataOrMgmtFrame *frameToSend)
{
    EV << "scheduling broadcast timeout period\n";
    scheduleAt(simTime() + computeFrameDuration(frameToSend), endTimeout);
}

void Ieee80211MimldMac::cancelTimeoutPeriod()
{
    EV << "cancelling timeout period\n";
    cancelEvent(endTimeout);
}

void Ieee80211MimldMac::scheduleCTSTimeoutPeriod()
{
...
void Ieee80211MimldMac::scheduleReservePeriod(Ieee80211Frame *frame)
{
...
void Ieee80211MimldMac::invalidateBackoffPeriod()
{
    backoffPeriod = -1;
}

bool Ieee80211MimldMac::isInvalidBackoffPeriod()
{
    return backoffPeriod == -1;
}

void Ieee80211MimldMac::generateBackoffPeriod()
{
...
void Ieee80211MimldMac::decreaseBackoffPeriod()
{
    // see spec 9.2.5.2
...
void Ieee80211MimldMac::scheduleBackoffPeriod()
{
    EV << "scheduling backoff period\n";
    scheduleAt(simTime() + backoffPeriod, endBackoff);
}

void Ieee80211MimldMac::cancelBackoffPeriod()
{
 ...
 */
void Ieee80211MimldMac::sendACKFrameOnEndSIFS()
{
...
void Ieee80211MimldMac::sendACKFrame(Ieee80211DataOrMgmtFrame *frameToACK)
{
...
void Ieee80211MimldMac::sendDataFrameOnEndSIFS(Ieee80211DataOrMgmtFrame *frameToSend)
{
...
void Ieee80211MimldMac::sendDataFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
    EV << "sending Data frame\n";
    sendDown(buildDataFrame(frameToSend));
}

void Ieee80211MimldMac::sendBroadcastFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
    EV << "sending Broadcast frame\n";
    sendDown(buildBroadcastFrame(frameToSend));
}

void Ieee80211MimldMac::sendRTSFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
    EV << "sending RTS frame\n";
    sendDown(setBasicBitrate(buildRTSFrame(frameToSend)));
}

void Ieee80211MimldMac::sendCTSFrameOnEndSIFS()
{
...
void Ieee80211MimldMac::sendCTSFrame(Ieee80211RTSFrame *rtsFrame)
{
 ...
 */
Ieee80211DataOrMgmtFrame *Ieee80211MimldMac::buildDataFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
...
Ieee80211ACKFrame *Ieee80211MimldMac::buildACKFrame(Ieee80211DataOrMgmtFrame *frameToACK)
{
...
Ieee80211RTSFrame *Ieee80211MimldMac::buildRTSFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
...
Ieee80211CTSFrame *Ieee80211MimldMac::buildCTSFrame(Ieee80211RTSFrame *rtsFrame)
{
...
Ieee80211DataOrMgmtFrame *Ieee80211MimldMac::buildBroadcastFrame(Ieee80211DataOrMgmtFrame *frameToSend)
{
    Ieee80211DataOrMgmtFrame *frame = (Ieee80211DataOrMgmtFrame *)frameToSend->dup();
    frame->setDuration(0);
    return frame;
...
Ieee80211Frame *Ieee80211MimldMac::setBasicBitrate(Ieee80211Frame *frame)
{
 ...
 * Helper functions.
 */
void Ieee80211MimldMac::finishCurrentTransmission()
{
    popTransmissionQueue();
    resetStateVariables();
}

void Ieee80211MimldMac::giveUpCurrentTransmission()
{
...
void Ieee80211MimldMac::retryCurrentTransmission()
{
...
Ieee80211DataOrMgmtFrame *Ieee80211MimldMac::getCurrentTransmission()
{
    if (transmissionQueue.empty())
        return NULL;
...
void Ieee80211MimldMac::sendDownPendingRadioConfigMsg()
{
    if (pendingRadioConfigMsg != NULL)
    {
...
void Ieee80211MimldMac::setMode(Mode mode)
{
    if (mode == PCF)
...
void Ieee80211MimldMac::resetStateVariables()
{
    backoffPeriod = 0;
    retryCounter = 0;
...
bool Ieee80211MimldMac::isMediumStateChange(cMessage *msg)
{
    return msg == mediumStateChange || (msg == endReserve && radioState == RadioState::IDLE);
}

bool Ieee80211MimldMac::isMediumFree()
{
    return radioState == RadioState::IDLE && !endReserve->isScheduled();
}

bool Ieee80211MimldMac::isBroadcast(Ieee80211Frame *frame)
{
    return frame && frame->getReceiverAddress().isBroadcast();
}

bool Ieee80211MimldMac::isForUs(Ieee80211Frame *frame)
{
...
bool Ieee80211MimldMac::isDataOrMgmtFrame(Ieee80211Frame *frame)
{
    return dynamic_cast<Ieee80211DataOrMgmtFrame*>(frame);
}

Ieee80211Frame *Ieee80211MimldMac::getFrameReceivedBeforeSIFS()
{
    return (Ieee80211Frame *)endSIFS->getContextPointer();
}

void Ieee80211MimldMac::popTransmissionQueue()
{
...
double Ieee80211MimldMac::computeFrameDuration(Ieee80211Frame *msg)
{
    return computeFrameDuration(msg->getBitLength(), bitrate);
}

double Ieee80211MimldMac::computeFrameDuration(int bits, double bitrate)
{
    return bits / bitrate + PHY_HEADER_LENGTH / BITRATE_HEADER;
}

void Ieee80211MimldMac::logState()
{
...
const char *Ieee80211MimldMac::modeName(int mode)
{
